...
LABELS = {'coco': LABEL_NAMES_COCO, 'pascal_voc': LABEL_NAMES_VOC, 'cityscapes': LABEL_NAMES_CITYSCAPES}
...
def vis_segmentation(image, seg_map, alpha=0.5, colorized=None, ds='coco', save_name=''):
    ...
    unique_labels = unique_labels[pixel_counts > 50]  # ignore labels that havel total number of pixels less than 51
